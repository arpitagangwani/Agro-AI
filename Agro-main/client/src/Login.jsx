...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const existingUser = JSON.parse(localStorage.getItem('user')); // Retrieve user data from local storage
    ...
    if (existingUser && existingUser.mobile === formData.mobile && existingUser.password === formData.password) {
      Cookies.set('loggedIn', true, { expires: 7 }); // Set a cookie upon successful login
